...
We will divide our preliminary procedures into two groups: directory setup and package loading. For the purposes of this document,
I will be running an additional code before. Since it only involves the nuances of the Markdown language used to create this
tutorial, you can safely ignore it and proceed to the next subsection.
...
As Rudy explained in the quote above, what we're now going to do is use a bunch of combinations of the loaded packages' functions
